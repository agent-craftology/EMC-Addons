...
public final class StatCard {
    ...
    public static void render(DrawContext ctx, TextRenderer tr, StatCardSource source, int x, int y, int w, int h,
    ...
    private static void drawDragHandle(DrawContext ctx, int x, int y, int color) {
    ...
    private static void drawSparkline(DrawContext ctx, TextRenderer tr, StatCardSource source, int x, int y, int w) {
        ...
        if (valueText != null && !valueText.isEmpty()) {
            GuiDraw.textShadow(ctx, tr, valueText, x + w - tr.getWidth(valueText), y, source.accentColor());
        }
        double[] values = source.sparklineValues();
