...
public final class WindowIcon {
    ...
    private static final Identifier VANILLA_16 = new Identifier("minecraft", "icons/icon_16x16.png");
    private static final Identifier VANILLA_32 = new Identifier("minecraft", "icons/icon_32x32.png");
