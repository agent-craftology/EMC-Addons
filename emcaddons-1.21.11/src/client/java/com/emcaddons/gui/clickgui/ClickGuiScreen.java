...
public class ClickGuiScreen extends Screen {
    ...
    public enum GameMode {
        DUNGEONS("dungeons", "Dungeons", false),
        GENS("gens", "Gens", true),
        FACTORIES("factories", "Factories", true),
        SKYBLOCK("skyblock", "Skyblock", true),
        PRISONS("prisons", "Prisons", true);

        public final String id;
        public final String title;
        public final boolean comingSoon;

        GameMode(String id, String title, boolean comingSoon) {
            this.id = id;
            this.title = title;
    ...
    private void rebuildRows() {
        ...
        switch (page) {
            ...
            case MODULE -> rows.addAll(ClickGuiPages.module(mod, this));
        }
        layoutRows();
    }
    ...
    GameMode selectedModule() {
        return selectedModule == null ? GameMode.DUNGEONS : selectedModule;
    }
    ...
    private void drawSidebar(DrawContext ctx, int mouseX, int mouseY) {
        ...
        drawNavSection(ctx, mouseX, mouseY, ny + 8, "CONFIGURATION", false);
    }
    ...
    private void drawHeader(DrawContext ctx, int mouseX, int mouseY) {
        ...
        switch (page) {
            ...
            case MODULE -> {
                GameMode mode = selectedModule();
                title = mode.title;
                sub = mode.comingSoon ? "Coming Soon!" : "Settings";
            }
            default -> { title = "Modules"; sub = "Manage modules"; }
        }
