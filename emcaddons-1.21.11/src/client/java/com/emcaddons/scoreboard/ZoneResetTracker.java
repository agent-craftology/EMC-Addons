...
public final class ZoneResetTracker {
    ...
    public boolean shouldSendQuery(boolean inDungeons, boolean masterVisible, boolean zoneCardVisible,
                                   boolean showRespawn) {
        if (!inDungeons || !masterVisible || !zoneCardVisible || !showRespawn) return false;
        long now = clock.getAsLong();
