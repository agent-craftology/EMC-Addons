...
public final class WindowIcon {
    ...
    private static final Identifier VANILLA_16 = Identifier.fromNamespaceAndPath("minecraft", "icons/icon_16x16.png");
    private static final Identifier VANILLA_32 = Identifier.fromNamespaceAndPath("minecraft", "icons/icon_32x32.png");

    private WindowIcon() {}

    public static void apply(Minecraft client, boolean craftologyEnabled) {
    ...
    private static void applyCraftology(Minecraft client, long handle) throws Exception {
    ...
    private static void applyVanilla(Minecraft client, long handle) throws Exception {
        List<NativeImage> owned = new ArrayList<>();
        try {
    ...
    private static NativeImage loadImage(Minecraft client, Identifier id) {
        try {
            ...
            IoSupplier<InputStream> supplier = client.getVanillaPackResources().getResource(PackType.CLIENT_RESOURCES, id);
